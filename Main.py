    ...
    def onRouteChange(e):
        ...
        if (parserdurl.path == "home"):
            page.views.append(View(
                ...
                horizontal_alignment="center", appbar=AppBar(title=Text('Upload' if parameters['mtype'][0] == 'True' else 'Download'+" files to vm's"), leading_width=40, bgcolor=colors.PURPLE, center_title=True, )),
            )
